...
namespace form_entry_mahasiswa
{
    public partial class Form1 : Form
    {
        ...
        {
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0925", Name = "ANANG", Gender = "Laki-laki", Born="Jakarta",Date="6/5/1999",Alamat="Sleman" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0946", Name = "WULAN", Gender = "Perempuan",Born="Jakarta",Date="6/5/1998",Alamat="Yogyakarta" });
